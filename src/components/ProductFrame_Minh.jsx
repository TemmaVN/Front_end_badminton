...
export default function ProductFrame_Minh({
  ...
  return (
    <>
      <div className=" flex flex-col relative w-full max-w-[240px] max-h-[365px] h-full  mx-auto rounded-b-lg p-4 shadow-sm hover:border-orange-500 hover:border-2 hover:scale-102 transition-all duration-300 cursor-pointer">
