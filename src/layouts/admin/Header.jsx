    ...
    border-slate-200/50 dark:border-slate-700/50 px-6 py-4'>
        <div className=' flex items-center justify-between'>
            ...
            <div className='flex items-center space-x-3'>
                ...
                {/*User Profile*/}
                <div className='flex items-center space-x-3 pl-3 border-l border-slate-200 dark:border-slate-800/50'>
                    <img
                    ...
                    />
                    <div className='hidden md:block'>
                        <p className='text-sm font-medium text-slate-800 dark:text-slate-400'>Admin</p>
